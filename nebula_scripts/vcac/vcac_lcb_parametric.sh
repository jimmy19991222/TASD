#!/usr/bin/env bash
# =============================================================================
# VCAC (Verdict-Conditioned Advantage Correction) — lcb_v6 parametric script.
...
save_path="${OSS_ROOT}/rl_models/${JOB_NAME:-vcac_lcb_sweep}"
...
python -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="${JOB_NAME:-vcac_lcb_sweep}" \
    trainer.group_name="VCAC-lcb" \
