...
echo "  - GRPO (off-policy): mini_batch=8, 4步更新"
echo "  - GRPO (on-policy): mini_batch=32, 1步更新（与 SDPO 公平对比）"
echo "数据集: ${DATASET}"
echo "模型: Qwen3-8B"
